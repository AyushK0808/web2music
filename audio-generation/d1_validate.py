def validate_profile(payload: dict) -> tuple[dict, str | None]:
    # Unwrap Sneha's Handoff 2 structure
    # She sends {"musicProfile": {...}, "prompt": "..."}
    # But also handle flat dict (direct API testing from Swagger)
    ...
    # Type coercions + clamping
    profile["bpm"]       = int(float(profile["bpm"]))   # handles "120.5" strings too
    ...
    # Mood validation — full list of Sneha's 11 moods
    valid_moods = {
